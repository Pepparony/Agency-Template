      ...
      <section className="h-screen w-screen bg-zinc-900 flex">
        <div className="w-1/2 flex flex-col justify-center place-items-end">
          <div className="flex flex-col pl-24 space-y-10">
            ...
            <p className="text-xl text-gray-100">From the recipe books in China, to three locations, the dumpling lady has gone from idea, to food truck, to restaurants, whilst pleasing thousands customers along the way.</p>
        ...
        <div className="w-1/2 grid grid-rows-2 grid-cols-2 place-items-center">
          <span><img src="https://cdn.doordash.com/media/consumer/home/landing/new/ScootScoot.svg" alt="" /></span>
          <span><img src="https://cdn.doordash.com/media/consumer/home/landing/new/ScootScoot.svg" alt="" /></span>
          <span><img src="https://cdn.doordash.com/media/consumer/home/landing/new/ScootScoot.svg" alt="" /></span>
          <span><img src="https://cdn.doordash.com/media/consumer/home/landing/new/ScootScoot.svg" alt="" /></span>
        </div>
